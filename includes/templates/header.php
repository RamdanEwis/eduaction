        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="navbars-host">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="includes\templates\courses">Course</a></li>
                    ...
                    <li class="nav-item"><a class="nav-link" href="includes\templates\teachers">Teachers</a></li>
